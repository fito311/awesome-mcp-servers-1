...
- **[47620 Solana Data](https://github.com/fito311/solana-data-mcp)** - Pay-per-call onchain data for AI agents over x402 (USDC, no signup, no API key): Solana network health, token price/liquidity, wallet balances, transaction lookup and trending DEX pairs, plus an MCP server trust/security score. Remote streamable-http at https://47620.xyz/mcp — official MCP Registry `xyz.47620/solana-data`.
